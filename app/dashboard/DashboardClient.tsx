...
// props que vienen del server (rol y email)
type DashboardProps = {
          ...
          >
            <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
              ...
              <div className="space-y-1">
                ...
                {/* NUEVO: info de usuario logueado */}
                <p className="text-[10px] text-slate-500">
                  Estás logueado como{" "}
                  <span className="font-semibold">{currentUserEmail}</span>{" "}
                  ({currentUserRole === "ADMIN" ? "ADMIN" : "OPERADOR"}).
                </p>
                ...
                <div className="flex items-center justify-end gap-2">
                  ...
                  {currentUserRole === "ADMIN" && (
                    <Link href="/admin/users">
                      <Button className="rounded-full px-3 py-1 text-[10px] bg-slate-200 text-slate-800 hover:bg-slate-300">
                        Roles y usuarios
                      </Button>
                    </Link>
                  )}
